...
describe("GET /api/v1/user", () => {
  describe("Anonymous user", () => {
    test("Retrieving the endpoint", async () => {
      ...
      expect(responseBody).toEqual({
        ...
        action:
          'Verifique se o seu usuário possui a feature "read:session" necessária para executar esta ação.',
        status_code: 403,
      });
    });
  });
  ...
  describe("Default user", () => {
    ...
    test("With halfway-expired session", async () => {
      ...
      const createdUser = await orchestrator.createUser({
        username: "UserWithHlfwayExpiredSession",
      });
    ...
    test("With nonexistent session", async () => {
      ...
      const response = await fetch(`${webserver.origin}/api/v1/user`, {
        headers: {
          cookie: `session_id=${nonexsistentToken}`,
        },
      });
    ...
    test("With expired session", async () => {
      ...
      const createdUser = await orchestrator.createUser({
        username: "UserWithHExpiredSession",
      });
